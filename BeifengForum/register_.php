...
/*        div{
  ...
  <p>注册</p>
    ...
    <div style="margin:20px">
      <form class="layui-form" action="register_.php" method="post">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-form-item">
          ...
          <input type="submit" class="layui-btn layui-btn-primary" lay-submit value="添加" style="width: 100px;border-radius:20px;color: #009688">         
          <input  type="button" onclick="javascript:window.location.href='manage.php'" class="layui-btn layui-btn-primary" value="返回" style="width: 100px;margin-left: 40px;border-radius:20px;color: #009688">
          </div>
        </div>
      </div>
      </form>
