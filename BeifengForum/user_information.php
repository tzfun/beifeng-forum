...
<form action="check_upinformation.php?action=information&play=update_information" method="post" accept-charset="utf-8">
  ...
  echo ('<P align="center" class="box2">昵称：<input type="text" name="new_name"  value="'.$result[0]['name'].'" ></P>');
    ...
    if ($result[0]['sex']=="boy") {
      ...
      echo ('<p class="box3" align="center">性别：<input  type="radio" name="new_sex" value="boy" style="margin-left:20px;">男
  ...
  echo ('<p align="center" style="margin-top:40px;"><input type="submit" value="更新" style="width:100px;background-color:#065279;color:white;margin-bottom:20px;" align="center"></p>');
